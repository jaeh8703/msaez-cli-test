...
public class PetController {
    ...
    public Pet test13(
        ...
        System.out.println("##### /pet/test13  called #####");
        Optional<Pet> optionalPet = petRepository.findById(id);
    ...
    public Pet test14(
        ...
        System.out.println("##### /pet/test14  called #####");
        Optional<Pet> optionalPet = petRepository.findById(id);
    ...
    public Pet test15(
        ...
        System.out.println("##### /pet/test15  called #####");
        Optional<Pet> optionalPet = petRepository.findById(id);
